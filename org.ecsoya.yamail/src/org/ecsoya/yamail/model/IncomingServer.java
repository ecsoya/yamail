 ...
 * <ul>
 * <li>{@link org.ecsoya.yamail.model.IncomingServer#getInterval <em>Interval
 * </em>}</li>
...
public interface IncomingServer extends YamailServer {
	...
	/**
	 * Returns the value of the '<em><b>Interval</b></em>' attribute. The
	 * default value is <code>"15"</code>. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Returns the value of the '<em><b>Check</b></em>' attribute. The default
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Check</em>' attribute.
	 * @see #isCheck()
	 * @generated
	 */
