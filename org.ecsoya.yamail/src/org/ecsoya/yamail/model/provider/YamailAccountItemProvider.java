...
/**
 * This is the item provider adapter for a {@link org.ecsoya.yamail.model.YamailAccount} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class YamailAccountItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_YamailAccount_name_feature", "_UI_YamailAccount_type"),
				 YamailPackage.Literals.YAMAIL_ACCOUNT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_YamailAccount_address_feature", "_UI_YamailAccount_type"),
				 YamailPackage.Literals.YAMAIL_ACCOUNT__ADDRESS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_YamailAccount_password_feature", "_UI_YamailAccount_type"),
				 YamailPackage.Literals.YAMAIL_ACCOUNT__PASSWORD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(YamailPackage.Literals.YAMAIL_ACCOUNT__INCOMING_SERVER);
			childrenFeatures.add(YamailPackage.Literals.YAMAIL_ACCOUNT__OUTGOING_SERVER);
			childrenFeatures.add(YamailPackage.Literals.YAMAIL_ACCOUNT__FOLDERS);
		}
	...
	/**
	 * This returns YamailAccount.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/YamailAccount"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_YamailAccount_type") :
